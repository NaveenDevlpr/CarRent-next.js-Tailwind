            ...
            <Dialog as='div' className='relative z-10' onClose={closeModel}>
                ...
                <div className='fixed inset-0 overflow-y-auto'>
                    ...
                    transition-all flex flex-col gap-5'>
                        ...
                        className='absolute z-10 right-2 top-2 w-fit p-2 bg-primary-blue-100 rounded-full'
                        >
                        ...
                        <div className='flex-1 flex flex-col gap-3'>
                            ...
                            <div className='flex gap-3'>
                                <div className='flex-1 relative  w-full h-24 bg-primary-blue-100 rounded-lg'>
                                    <Image src={generateCarImageUrl(car,'29')} alt='' fill priority className='object-contain'></Image>
                                </div>
                                <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                                    <Image src={generateCarImageUrl(car,'33')} alt='' fill priority className='object-contain'></Image>
                                </div>
                                <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                                    <Image src={generateCarImageUrl(car,'13')} alt='' fill priority className='object-contain'></Image>
                                </div>
                            </div>
                        </div>
